...
- **Run the code.** All code examples are available on [GitHub](https://github.com/michael-borck/code-python-consult-ai). [DeepWiki](https://deepwiki.com/michael-borck/code-python-consult-ai) provides an AI-navigable view of the repository.
