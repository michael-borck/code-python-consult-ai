...
One note on the Building Session listings: from version to version they sometimes trim unrelated earlier features for space. When a listing shows only part of your chatbot, keep the features you have already built; each chapter tells you what to add, never what to remove.
...
|---|---|---|
| *Conversation, Not Delegation* | *Build Web, Guide AI*, or *Converse Python, Partner AI* | You want the ideas before (or without) code |
| *Think Python, Direct AI* | *Code Python, Consult AI* (this book), then *Ship Python, Orchestrate AI* | You want to code from your first page |
...
- **Converse Python, Partner AI**: the intentional prompting methodology applied to software development. A companion you can read alongside any Python book.
- **Code Python, Consult AI** (this book): focused Python fundamentals through AI conversation.
