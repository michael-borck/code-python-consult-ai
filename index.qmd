...
If you worked through *Think Python, Direct AI*, you have already built projects using most of the concepts in this book. You used variables, functions, lists, and dictionaries — but you used them to solve problems, not to study them. This book makes the implicit explicit. It takes the Python you practiced and gives you the understanding to use it deliberately.
