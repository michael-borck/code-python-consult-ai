...
## Craft Your Prompt: A Step-by-Step Approach
...
- Do you want to optimise existing code?
...
## Prompting Patterns for Different Python Tasks
...
It works correctly, but I'm looking to optimise it for [speed/memory/readability/etc.].
...
It works correctly, but I'm looking to optimise it for speed.
...
## Prompting for the Six Core Programming Foundations
...
- Performance considerations include minimising memory usage for very large files
...
3. What is "chain-of-thought" prompting?
   ...
   d) A system for organising programming concepts
...
## Project Corner: Enhancing Your Chatbot with Intentional Prompting
...
List comprehensions are more readable and often faster than traditional for loops.

You: Can you help me fix this code? my_list = [1,2,3] print(my_list[3])
PyBot: The issue is an IndexError. List indices start at 0, so a list with 3 elements has indices 0, 1, and 2.
...
## Prompting Ethics and Best Practices
...
4. **Respect for AI Limitations**: recognise that AI assistants have limitations and may generate incorrect information. Verify critical information and test generated code.
...
- Previous Chapter: [AI Assistance Tips](ai_assistance_tips.qmd)
