...
- Use dictionaries to organise complex data
...
You may recognise dictionaries from the Contact Book project in *Think Python, Direct AI*, where you used them to store names and phone numbers. Here we explore dictionaries more thoroughly — how they work, the full range of methods, nested structures, and the many patterns that make dictionaries essential to Python programming.
:::
...
- **Mutating while iterating**: Modifying a dictionary while looping through it can lead to unexpected behaviour
...
Let's enhance our chatbot by using dictionaries to organise response patterns and templates:
...
1. Uses dictionaries to organise response patterns and templates
...
- Previous Chapter: [Strings](strings.qmd)
- Next Chapter: [Files](files.qmd)
- Related Topics: Lists (Chapter 11), Looping (Chapter 12)

***AI Tip: Ask your AI assistant to suggest ways dictionaries could be used to solve specific data organisation problems in your projects.***
