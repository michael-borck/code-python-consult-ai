...
This notebook demonstrates loading and analysing a CSV file of sales data.
```
...
- Previous Chapter: [Orientating Your Objects](orientating_your_objects.qmd)
- Next Chapter: [How to Install Python](how_to_install_python_testing.qmd)
