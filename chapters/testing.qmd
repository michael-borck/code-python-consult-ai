...
Update my chatbot to v1.8. First, save your chatbot script as `chatbot.py` in your project folder so the tests can import it (Chapter 19 covers modules properly). Then create a test file `tests/test_chatbot.py` with pytest tests for:
