...
def get_weather(city="London"):
    ...
    base = f"http://api.openweathermap.org"
...
to a JSON file with proper error handling.
The function should take three parameters: the
dictionary to save, the filename to save to,
and an optional parameter to format the JSON
...
quotes = [
    ...
    "to write programs. - Dennis Ritchie",
]
...
quote_categories = {
    ...
    "motivation": [
        "Learn programming by writing programs. - Ritchie",
        "The journey begins with a single line of code.",
    ]
}

category = input("Quote type? (programming/motivation): ")
category = category.lower()
if category not in quote_categories:
    print(f"'{category}' not found. Using random.")
    category = random.choice(
        list(quote_categories.keys())
    )
