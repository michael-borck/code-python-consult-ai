...
- recognise basic programming elements like functions and strings
- Preview the chatbot project you'll build throughout this book

::: {.callout-tip title="Code available online" icon=true}
Code examples and Jupyter notebooks for all chapters are available in the `code/` folder on GitHub. Notebooks include "Open in Colab" buttons for zero-install coding. See [books.borck.education](https://books.borck.education) for links.
:::
...
3. Best practices for organising my notebook
...
1. recognises `print` as a built-in function
...
- Next Chapter: [Basic Python Syntax](basic_python_syntax.qmd) — Learn the grammar of Python
- Chatbot Evolution: Watch our chatbot grow in [Input](input.qmd) where we add user interaction
- Advanced Concepts: See how our simple output evolves with [Strings](strings.qmd) and [Dictionaries](dictionaries.qmd)
- AI Integration: Later, in [AI Programming Assistants](ai_programming_assistants.qmd), we'll enhance our chatbot with AI capabilities
