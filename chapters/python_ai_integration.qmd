# Connecting Python to AI Services
...
def analyze_image(image_url, api_key=None, endpoint=None):
    """
    analyse an image using Azure Computer Vision API.

    Args:
        image_url (str): URL of the image to analyse
    ...
    # API URL
    vision_url = f"{endpoint}/vision/v3.2/analyse"
...
class MessageUnderstanding:
    ...
    def analyze_intent(self, message):
        """
        analyse the intent of a user message.
        ...
        try:
            ...
            prompt = f"""
            analyse the following message and determine the user's intent.
            ...
            print(f"Error analysing intent: {e}")
            return {"intent": "unknown", "confidence": 0.0}
    ...
    def extract_entities(self, message):
        ...
        try:
            ...
            Possible entity types: person, location, organisation, date_time, product, quantity, other
...
- Previous Chapter: [Working with AI Assistants](working_with_ai_assistants.qmd)
- Appendix: [Setting Up Python](../appendices/setting_up_python.qmd)
