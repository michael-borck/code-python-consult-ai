...
- Best practices for code organisation
...
- Explore and utilise modules from Python's standard library
- Find and install third-party packages
- Create your own reusable modules
- Structure your code for better organisation and reuse
...
A **module** is simply a Python file containing code that can be imported and reused. A **package** is a collection of related modules organised in directories. Together, they enable several crucial benefits:

- **Reuse**: Write code once, use it in multiple projects
- **organisation**: Structure large codebases logically
...
As your projects grow, you'll want to organise your code into reusable modules. Creating a module is as simple as saving Python code in a `.py` file.
...
## 6. organising Real-World Python Projects

As your projects grow more complex, a clear organisation becomes crucial. Here's a common structure for medium-sized Python projects:
...
Now that you understand modules and packages, let's apply this knowledge to our chatbot project. We'll organise the chatbot into a proper modular structure:
...
This modular organisation offers several advantages:

1. **Separation of Concerns**: Each module has a specific responsibility
2. **Readability**: Code is organised into logical units
...
- Previous Chapter: [Testing](testing.qmd)
- Next Chapter: [Orientating Your Objects](orientating_your_objects.qmd)
- Related Topics: Functions (Chapter 9), Error Handling (Chapter 16), Testing (Chapter 18)

***AI Tip: When organising your code into modules, ask your AI assistant to help identify logical groupings of functions. Describe what your code does, and the AI can suggest a modular structure that follows good design principles.***
...
By mastering modules and packages, you're learning the fundamental organising principle that powers Python's success across these diverse domains.
