...
- Should you use the official Python distribution or a customised one?
...
# For Windows (split for readability)
...
This comprehensive setup gives you a solid foundation for your chatbot project, with proper organisation, dependency management, and version control from the start.

## Cross-References

- Previous Chapter: [How to Run Python Code](how_to_run_python_code.qmd)
- Next Chapter: [Getting Help](getting_help.qmd)
...
By following these guidelines, you'll have a clean, organised Python setup that will serve you well as you continue your programming journey. The isolation provided by environments helps prevent dependency conflicts and makes it easier to work on multiple projects simultaneously.
