...
- utilising online resources effectively
...
- utilise Python's built-in help functions to find information
...
Python comes with excellent built-in tools for finding information about objects, functions, and modules. These are your first line of defence when you need to understand how something works.
...
The official Python documentation at [docs.python.org](https://docs.python.org/) is comprehensive and well-organised:
...
3. **Debugging errors** by analysing error messages
...
my bot isn't recognising it as a greeting.
...
- Previous Chapter: [Installation and Practical Considerations](how_to_install_python_testing.qmd)
- Next Chapter: [Taking it Further](ai_programming_assistants.qmd)
