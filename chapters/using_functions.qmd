...
- Capture and utilise return values from functions
...
- recognise function patterns in AI-generated code
...
Think of functions as the verbs of programming - they do things. When you work with AI programming assistants or analyse code written by others, recognising and understanding functions will be crucial to your success. Functions allow programmers to break complex problems into smaller, manageable pieces - a technique that remains essential even when collaborating with AI.

As we progress through this book, you'll see how functions become increasingly important. They're the fundamental organisation units of code that both human and AI programmers use to create structured, efficient programs.
...
In the age of AI programming assistants, functions remain critically important. When an AI assistant generates code for you, it will typically organise that code into functions. Understanding how to read, modify, and work with these functions is an essential skill.
...
AI assistants often organise solutions into functions:
...
Notice how the solution is organised into two functions, each handling a specific part of the problem.
...
Often, you'll need to customise functions that AI generates:
...
This chatbot is functional but still has its logic all in one place. In Chapter 9, we'll learn to create our own functions to better organise our code and make our chatbot more maintainable.
...
As you learn to create your own functions in the next chapter, you'll be able to make your chatbot even more organised and powerful.
...
- Previous Chapter: [Operators](operators.qmd)
- Next Chapter: [Creating Functions](creating_functions.qmd)
...
Functions are the building blocks of Python programming, allowing you to perform tasks without understanding all the underlying details. They provide modularity, reusability, and organisation to your code.
...
Remember that both human programmers and AI assistants organise code using functions - they're the universal building blocks of structured programs. By mastering functions, you're taking a significant step toward effective programming in the AI era.
